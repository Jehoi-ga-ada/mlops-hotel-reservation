    ...
    def run(self):
        try: 
            with mlflow.start_run():
                ...
                logger.info(f"Logging training and testing dataset to MLFLOW")
                ...
                logger.info("Logging the model into the MLFLOW")
                ...
                logger.info("Model pipeline process finished")
            
        except Exception as e:
            logger.error(f"Error while running model pipeline {e}")
            raise CustomException("Failed to run model pipeline", e)
